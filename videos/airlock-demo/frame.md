...
colors:
  ...
  text-muted: "#BBF7D0"
  text-light: "#656565"
  accent-light: "rgba(103, 232, 249, 0.08)"
  accent-medium: "rgba(103, 232, 249, 0.15)"
  border: "rgba(103, 232, 249, 0.2)"
  card-bg: "rgba(103, 232, 249, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **DM Mono** (display) / **Inter** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{400, 500, 600, 650, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
